...
add_action( 'tgmpa_register', 'carspa_resister_required_plugin' );
/**
 ...
 */
function carspa_resister_required_plugin() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'               => esc_html__( 'Droit Header Footer Builder', 'carspa' ), // The plugin name.
            'slug'               => 'droit-header-footer-builder', // The plugin slug (typically the folder name).
            'source'             => 'http://preview.droitthemes.com/wp/carspa/downloadfile/droit-header-footer-builder.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ...
        array(
            'name'      => esc_html__( 'Metform', 'carspa' ),
            'slug'      => 'metform',
            'required'  => true,
        ),
